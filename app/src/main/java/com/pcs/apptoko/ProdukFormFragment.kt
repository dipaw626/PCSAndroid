...
class ProdukFormFragment : Fragment() {
    ...
    //local
//    private lateinit var txtFormNama: TextView
//    private lateinit var txtFormHarga: TextView
//    private lateinit var txtFormStok: TextView
...
//        txtFormNama = view.findViewById(R.id.txtFormNama)
//        txtFormHarga = view.findViewById(R.id.txtFormHarga)
//        txtFormStok = view.findViewById(R.id.txtFormStok)
        ...
        if (status == "edit") {
            ...
            txtFormHarga.setText(produk?.nama.toString())
            txtFormStok.setText(produk?.nama.toString())
        }
        ...
        btnProsesProduk.setOnClickListener{
            ...
            if (status == "edit") {
                api.putProduk(token.toString(),produk?.id.toString().toInt(),adminId.toString().toInt(),
                    txtFormNama.text.toString(),txtFormHarga.text.toString().toInt(),txtFormStok.text.toString().toInt()).enqueue(
                ...
                api.postProduk(token.toString(),adminId.toString().toInt(),txtFormNama.text.toString(),txtFormHarga.text.toString().toInt(),
                txtFormStok.text.toString().toInt()).enqueue(object : Callback<ProdukResponsePost> {
                    override fun onResponse(
                        call: Call<ProdukResponsePost>,
                        response: Response<ProdukResponsePost>
                    ) {
